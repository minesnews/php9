...
/* user-auth.tpl */
class __TwigTemplate_32eb1ea44c217124138a258d4a58ef65 extends Template
{
    private $source;
    private $macros = [];
...
<form action=\"/user/login/\" method=\"post\">
  ...
  <p><input type=\"submit\" value=\"Войти\"></p>
    ...
    {
        return new Source("", "user-auth.tpl", "/data/mysite.local/src/Domain/Views/user-auth.tpl");
    }
}
